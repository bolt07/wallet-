            ...
            <div className="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                ...
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        }} className="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-green-500 text-white">Iniate Transfer</button>
                    </div>
                </div>
            </div>
        </div>
